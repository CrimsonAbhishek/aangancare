...
export const serviceRequests = mysqlTable("serviceRequests", {
  ...
  email: varchar("email", { length: 320 }),
  notes: text("notes"),
  consentToProcess: int("consentToProcess").default(0).notNull(),
  termsAcknowledged: int("termsAcknowledged").default(0).notNull(),
  privacyPolicyVersion: varchar("privacyPolicyVersion", { length: 40 }).default("draft").notNull(),
  termsVersion: varchar("termsVersion", { length: 40 }).default("draft").notNull(),
